...
public class TableBilliardController {
    ...
    public ResponseEntity<ApiResponse<TableBilliardResponse>> createTableBilliard(
            @Valid @RequestBody TableBilliardRequest request) {
    ...
    public ResponseEntity<ApiResponse<TableBilliardResponse>> updateTableStatus(
            @PathVariable Long id,
            @RequestParam TableStatus status) {
        TableBilliardResponse res = tableBilliardService.updateTableStatus(id, status);
        return ResponseUtil.success(res, "Cập nhật trạng thái bàn thành công");
    }
}
